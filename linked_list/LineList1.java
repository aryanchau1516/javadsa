...
// its print middle right ele when list is even ...
            ...
            int deleteNthNodeInOneTrv(int n){
                Node slow =head;
                Node fast = head;
                for(int i=1;i<n;i++){
                    fast=fast.next;
                ...
                while (fast.next.next!=null) {
                    slow=slow.next; // one previous of nth node
                    fast= fast.next;
                }
                int ele = slow.next.data;
                slow.next=slow.next.next;
                return ele;
            }
        ...
        //   obj.insertAt(3, 67);
          //System.out.println(obj.size-3+1);
          obj.display();
         // System.out.println(obj.nthEndNode( 3));
        //  System.out.println(obj.nthEndNodeInOneTrv( 3));
         // System.out.println(obj.deleteNthNodeInOneTrv(3));
         // System.out.println();
          // obj.display();
           System.out.println();
        //    obj.deleteAt(2);
       ...
       // obj.delmiddle();
       // System.out.println();
       System.out.println(obj.middleEle());
       System.out.println();
        obj.display();
        }
